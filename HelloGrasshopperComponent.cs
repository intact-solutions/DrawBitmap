...
namespace HelloGrasshopper
{
    public class HelloGrasshopperComponent : GH_Component
    {
        ...
        public HelloGrasshopperComponent()
          : base("HelloGrasshopperComponent", "ASpi",
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("b7aa8b8c-64b1-409f-b0a6-3c21b16fe532");


        public override void DrawViewportMeshes(IGH_PreviewArgs args)
        {
            System.Drawing.Bitmap b = new System.Drawing.Bitmap(Resource1.RainbowDesaturated, new System.Drawing.Size(25, 200));
            var displayBitmap = new DisplayBitmap(b);

            args.Display.DrawBitmap(displayBitmap, 50, 50);
